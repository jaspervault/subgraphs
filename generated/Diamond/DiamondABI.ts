...
export class DiamondABI__getCallOrderResultValue0Struct extends ethereum.Tuple {
  get holder(): Address {
    return this[0].toAddress();
  }
...
export class DiamondABI__getPutOrderResultValue0Struct extends ethereum.Tuple {
  get holder(): Address {
    return this[0].toAddress();
  }
...
export class DiamondABI extends ethereum.SmartContract {
  static bind(address: Address): DiamondABI {
    return new DiamondABI("DiamondABI", address);
  }

  getCallOrder(_orderId: BigInt): DiamondABI__getCallOrderResultValue0Struct {
    ...
    return changetype<DiamondABI__getCallOrderResultValue0Struct>(
      result[0].toTuple(),
    );
  }
  ...
  try_getCallOrder(
    _orderId: BigInt,
  ): ethereum.CallResult<DiamondABI__getCallOrderResultValue0Struct> {
    ...
    return ethereum.CallResult.fromValue(
      changetype<DiamondABI__getCallOrderResultValue0Struct>(
        value[0].toTuple(),
      ),
    );
  }
  ...
  getPutOrder(_orderId: BigInt): DiamondABI__getPutOrderResultValue0Struct {
    let result = super.call(
      "getPutOrder",
    ...
    return changetype<DiamondABI__getPutOrderResultValue0Struct>(
      result[0].toTuple(),
    );
  }
  ...
  try_getPutOrder(
    _orderId: BigInt,
  ): ethereum.CallResult<DiamondABI__getPutOrderResultValue0Struct> {
    let result = super.tryCall(
      "getPutOrder",
      "getPutOrder(uint64):((address,uint8,address,uint8,address,address,address,uint256,uint256,uint256,uint256))",
      [ethereum.Value.fromUnsignedBigInt(_orderId)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<DiamondABI__getPutOrderResultValue0Struct>(value[0].toTuple()),
    );
  }
